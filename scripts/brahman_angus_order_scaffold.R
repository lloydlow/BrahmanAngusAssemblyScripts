#------------------------------------------------------
# Program name: brahman_angus_order_scaffold.R
...
##### Dam #####
dam_mashmap <- read_delim("/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/brahman_Angus_mashmap/script/f1_dam_salsa_mash_UCDv25.mashmap",
                          " ", col_names = FALSE)
...
##### Sire #####
sire_mashmap <- read_delim("/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/brahman_Angus_mashmap/script/f1_sire_salsa_mash_UCDv25.mashmap",
                          " ", col_names = FALSE)
...
load("/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/dam_contig_scaff.RData")
load("/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/sire_contig_scaff.RData")
# END contig mapping to scaffold #

# START HD and rc probes #
load("/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/f1_dam_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes.RData")
load("/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/f1_sire_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes.RData")
...
for (i in 1:nrow(dam_contig_scaff)){
  ...
  #probes HD 
  logic <- f1_dam_salsa_HDProbes_tab_by_chrScaff_mostprobes$scaffold %in% dam_contig_scaff$object[i]
  holder <- f1_dam_salsa_HDProbes_tab_by_chrScaff_mostprobes$chromosome[logic]
  if (!is.integer0(holder)) {chr_HD <- c(chr_HD,holder)} else {chr_HD <- c(chr_HD,NA)}
  holder <- f1_dam_salsa_HDProbes_tab_by_chrScaff_mostprobes$n[logic]
  if (!is.integer0(holder)) {HD_n <- c(HD_n,holder)} else {HD_n <- c(HD_n,NA)}
  
  #probes rc
  logic <- f1_dam_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes$scaffold %in% dam_contig_scaff$object[i]
  holder <- f1_dam_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes$chromosome[logic]
  if (!is.integer0(holder)) {chr_rc <- c(chr_rc,holder)} else {chr_rc <- c(chr_rc,NA)}
  holder <- f1_dam_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes$n[logic]
...
for (i in 1:nrow(sire_contig_scaff)){
  ...
  #probes HD 
  logic <- f1_sire_salsa_HDProbes_tab_by_chrScaff_mostprobes$scaffold %in% sire_contig_scaff$object[i]
  holder <- f1_sire_salsa_HDProbes_tab_by_chrScaff_mostprobes$chromosome[logic]
  if (!is.integer0(holder)) {chr_HD <- c(chr_HD,holder)} else {chr_HD <- c(chr_HD,NA)}
  holder <- f1_sire_salsa_HDProbes_tab_by_chrScaff_mostprobes$n[logic]
  if (!is.integer0(holder)) {HD_n <- c(HD_n,holder)} else {HD_n <- c(HD_n,NA)}
  
  #probes rc
  logic <- f1_sire_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes$scaffold %in% sire_contig_scaff$object[i]
  holder <- f1_sire_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes$chromosome[logic]
  if (!is.integer0(holder)) {chr_rc <- c(chr_rc,holder)} else {chr_rc <- c(chr_rc,NA)}
  holder <- f1_sire_salsa_fasta_rcmap_tab_by_chrScaff_mostprobes$n[logic]
  if (!is.integer0(holder)) {rc_n <- c(rc_n,holder)} else {rc_n <- c(rc_n,NA)}
...
save(dam_scaff_order_DF,sire_scaff_order_DF,
     file = "/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/scaff_order_DF.RData")
