#------------------------------------------------------
# Program name: brahman_angus_vcf_score_alt_allele_SevenBreeds_BrahmanRef.R
# Objective: tested code to detect extended haplotype homozygosity
#           and apply to after annovar results now
# Author: Lloyd Low
...
#folder: /Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/Annotation/EBI_Brahman_SevenBreeds

#get chr no
chr <- gsub("SevenBreedsRefBrahman_filteredSNP.Brahman_multianno_","",vcfFile)
chr <- gsub(".vcf","",chr)

# path to annotated vcf
dir1 <- 
  "/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/Annotation/EBI_Brahman_SevenBreeds/"

# reading SevenBreedsRefBrahman_filteredSNP_7.vcf 
#path1 <- paste0(dir1,"combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1.vcf")

path1 <- paste0(dir1,"SevenBreedsRefBrahman_filteredSNP.Brahman_multianno_14.vcf")
