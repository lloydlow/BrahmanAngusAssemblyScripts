#------------------------------------------------------
# Program name: brahman_angus_SV_Assemblytics_3.R
...
feat <- genFeatures(arsucd12r96_txdb, featuretype="all", reduce_ranges=TRUE, upstream=1000, downstream=0)
...
#Brahman
#exon
ebi_overlap_selection_exon_Brahman_df <- mergeByOverlaps(feat$exon_red, sv_interval_Brahman)
...
#Brahman
#intron
ebi_overlap_selection_intron_Brahman_df <- mergeByOverlaps(feat$intron_red, sv_interval_Brahman)
...
#Brahman
#promoter
ebi_overlap_selection_promoter_Brahman_df <- mergeByOverlaps(feat$promoter_red, sv_interval_Brahman)
...
#Brahman
#cds
ebi_overlap_selection_cds_Brahman_df <- mergeByOverlaps(feat$cds_red, sv_interval_Brahman)
...
# #Brahman
# #fiveUTR_red
# ebi_overlap_selection_fiveUTR_red_Brahman_df <- mergeByOverlaps(feat$fiveUTR_red, sv_interval_Brahman)
# 
# fiveUTR_red_Brahman <- table(ebi_overlap_selection_fiveUTR_red_Brahman_df$type)
# 
# fiveUTR_red_Brahman_df <- data.frame(rbind(fiveUTR_red_Brahman))
# 
# #Brahman
# #threeUTR_red
# ebi_overlap_selection_threeUTR_red_Brahman_df <- mergeByOverlaps(feat$threeUTR_red, sv_interval_Brahman)
# 
# threeUTR_red_Brahman <- table(ebi_overlap_selection_threeUTR_red_Brahman_df$type)
# 
# threeUTR_red_Brahman_df <- data.frame(rbind(threeUTR_red_Brahman))

################################################################################################
#Angus
#exon
ebi_overlap_selection_exon_Angus_df <- mergeByOverlaps(feat$exon_red, sv_interval_Angus)
...
#Angus
#intron
ebi_overlap_selection_intron_Angus_df <- mergeByOverlaps(feat$intron_red, sv_interval_Angus)
...
#Angus
#promoter
ebi_overlap_selection_promoter_Angus_df <- mergeByOverlaps(feat$promoter_red, sv_interval_Angus)
...
#Angus
#cds
ebi_overlap_selection_cds_Angus_df <- mergeByOverlaps(feat$cds_red, sv_interval_Angus)
...
# #Angus
# #fiveUTR_red
# ebi_overlap_selection_fiveUTR_red_Angus_df <- mergeByOverlaps(feat$fiveUTR_red, sv_interval_Angus)
# 
# fiveUTR_red_Angus <- table(ebi_overlap_selection_fiveUTR_red_Angus_df$type)
# 
# fiveUTR_red_Angus_df <- data.frame(rbind(fiveUTR_red_Angus))
# 
# #Angus
# #threeUTR_red
# ebi_overlap_selection_threeUTR_red_Angus_df <- mergeByOverlaps(feat$threeUTR_red, sv_interval_Angus)
# 
# threeUTR_red_Angus <- table(ebi_overlap_selection_threeUTR_red_Angus_df$type)
# 
# threeUTR_red_Angus_df <- data.frame(rbind(threeUTR_red_Angus))
...
tiff(filename = "SV_vs_annotation_type.tiff", width = 1000)
