#------------------------------------------------------
# Program name: brahman_angus_vcf_score_alt_allele_BrahmanRef.R
...
#folder: /Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/Annotation/EBI

#get chr no
chr <- gsub("combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_","",vcfFile)
chr <- gsub(".vcf","",chr)
...
# reading combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1.vcf
#path1 <- paste0(dir1,"combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1.vcf")

path1 <- paste0(dir1,"combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_24.vcf")
...
combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro$interval <- 
  with(combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro, cut(POS, seq(1, max(POS), by = 100e3)))

# proportion_diff_df <- combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro %>% 
#   group_by(interval) %>% summarise(proportion_diff_mean = mean(proportion_diff))
...
assign(paste('combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro_', chr, sep=''), 
       combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro)

path2 <- paste0(dir1,'combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro_',chr,".RData")

save(list = paste0('combinedBreedRefBrahman_filteredSNP.Brahman_multianno_subset_1_split_GT_pro_', chr),file = 
       path2)
