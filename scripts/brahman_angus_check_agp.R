#------------------------------------------------------
# Program name: brahman_angus_check_agp.R
# Objective: check agp file from the start of 
#           scaffolding of the various versions
# Author: Lloyd Low
...
# reading scaffolds_FINAL.agp from dam immediately after salsa
dir1 <- "/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/scaffolding/salsa_result_original_from_Jay/dam/"
path1 <- paste0(dir1,"scaffolds_FINAL.agp")

dam_scaffolds_FINAL_agp <- read_tsv(path1,col_names = FALSE)
...
#90% bases in 71 scaffolds that was put together with more than 1 contig
...
#1040     27049     38922   1955306     55304 156852538 
...
save(dam_contig_scaff,
     file = "/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/dam_contig_scaff.RData")

############sire####################################################################
# reading scaffolds_FINAL.agp from dam immediately after salsa
dir2 <- "/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/scaffolding/salsa_result_original_from_Jay/sire/"
path2 <- paste0(dir2,"scaffolds_FINAL.agp")

sire_scaffolds_FINAL_agp <- read_tsv(path2,col_names = FALSE)
...
#Min.   1st Qu.    Median      Mean   3rd Qu.      Max. 
#13938    369758   2356210  30307001  60454903 253620839 
...
save(sire_contig_scaff,
     file = "/Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/order_scaffolds_to_chr_level/sire_contig_scaff.RData")
