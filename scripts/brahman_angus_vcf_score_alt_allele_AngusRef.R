#------------------------------------------------------
# Program name: brahman_angus_vcf_score_alt_allele_AngusRef.R
# Objective: from vcf annotated with annovar, count
#           alt alleles using Angus as Ref
# Author: Lloyd Low
...
#folder: /Users/lloyd/Documents/lloyd_2017/Research/Brahman_Angus/Assembly_version/final_to_correct_20180905/Annotation/EBI_Angus
